/* Jogue o jogo da velha contra o seu amigo ou contra o bot.
Se você escolheu jogar contra o bot , the 'Computer Player' Usará a função getBestMove para escolher os mehlores movimentos possiveis.
*/
...
function Board (options){
  ...
  function render(){
    ...
    function htmlQ1(){
      return `<div id="view1"><h3>Qual você prefere ?\n</h3>
      ${buttonHTML(1, "1player", "Pessoa contra bot")}
      ${buttonHTML(1, "2players", "Pessoa contra pessoa")}
      </div>`
    }

    function htmlQ2(){
      const html2=`<div id="view2"><h3>${!state.players[1].isComputer? "Player 1, <br />" : ""}Qual simbolo você quer usar?</h3>
      ${buttonHTML(2, "X", "X")}
      ${buttonHTML(2, "O", "O")}`
      return html2
    }
